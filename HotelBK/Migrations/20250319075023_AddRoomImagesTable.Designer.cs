...
namespace HotelBK.Migrations
{
    ...
    [Migration("20250319075023_AddRoomImagesTable")]
    partial class AddRoomImagesTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("HotelBK.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 3, 19, 14, 50, 23, 136, DateTimeKind.Local).AddTicks(9763),
                            Email = "admin@example.com",
                            FullName = "Admin",
                            PasswordHash = "AQAAAAIAAYagAAAAEJ6+r7NilG+P6CUyCvxQ7WoOg7VylB9LsssJtQtA9dRV8k8nXJ0egjb1tujh3ZTenw==",
                            Phone = "0123456789",
                            RoleID = 1
                        });
                });
